...
files = ['variables_bpi2012_true.pkl']

# Iterate over control files list
for filename_variables in files:
    ...
    # for loop for testing all the batch sizes
    ...
    for batch_size in sizes:
        ...
        variables['num_layers'] = 4
        variables['d_model'] = 12
        variables['num_heads'] = 3
        variables['dff'] = 48
